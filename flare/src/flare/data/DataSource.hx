package flare.data;
	...
	class DataSource
	{
		...
		public var schema(getSchema, null) : DataSchema ;
		...
		public function getSchema():DataSchema { return _schema; }
		 ...
		 *  data set
		 */
		public function new(url:String, format:String, ?schema:DataSchema=null)
		{
			_url = url;
			_format = format;
			_schema = schema;
