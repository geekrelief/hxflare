package flare.animate;
	...
	class Scheduler
	{
		public var instance(getInstance, null) : Scheduler ;
		public var timerInterval(getTimerInterval, setTimerInterval) : Number;
		private static var _instance:Scheduler = new Scheduler(_Lock);
		/** The default Scheduler instance. */
		public static function getInstance():Scheduler { return _instance; }
		
		private var _scheduled:Array<Dynamic>; // list of all currently scheduled items
		private var _ids:Dynamic;      // map of all named items
		 ...
		 */
		public function getTimerInterval():Number { return _timer.delay; }
		public function setTimerInterval(t:Number):Number {
		 ...
		 */
		public function remove(item:ISchedulable) : Bool
		{
