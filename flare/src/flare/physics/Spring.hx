package flare.physics;
	...
	class Spring
	{
		 ...
		 */
		public function new(p1:Particle, p2:Particle, ?restLength:Int=10,
							   ?tension:Float=0.1, ?damping:Float=0.1)
		{
		 ...
		 * @param damping the damping (friction) co-efficient of the spring
		 */
		public function init(p1:Particle, p2:Particle, ?restLength:Int=10,
							 ?tension:Float=0.1, ?damping:Float=0.1):Void
		{
			this.p1 = p1;
			this.p2 = p2;
