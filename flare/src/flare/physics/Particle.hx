package flare.physics;
	...
	class Particle
	{
		 ...
		 *  fixed position
		 */
		public function new(?mass:Int=1, ?x:Int=0, ?y:Int=0,
								 ?vx:Int=0, ?vy:Int=0, ?fixed:Bool=false)
		{
		 ...
		 *  fixed position
		 */
		public function init(?mass:Int=1, ?x:Int=0, ?y:Int=0,
			?vx:Int=0, ?vy:Int=0, ?fixed:Bool=false):Void
		{
			this.mass = mass;
			this.degree = 0;
			this.x = x;
