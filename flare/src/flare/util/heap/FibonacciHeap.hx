package flare.util.heap;
	...
	class FibonacciHeap
	{
		public var empty(getEmpty, null) : Bool
		;
		 ...
		 */		
		public function insert(data:Dynamic,
			?key:Int=Number.POSITIVE_INFINITY):HeapNode
		{
	    ...
	    private function consolidate():Void
	    {
	    	...
	    	var array:Array<Dynamic> = new Array(arraySize);
	    	var i:UInt;
