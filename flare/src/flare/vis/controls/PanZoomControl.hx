package flare.vis.controls;
	 ...
	 */
	class PanZoomControl extends Control
	{
		 ...
		 */
		public function new(?hitArea:InteractiveObject=null){
		...
		{
			var dw:Float = 1.1 * event.delta;
			var dz:Int = dw < 0 ? 1/Math.abs(dw) : dw;
