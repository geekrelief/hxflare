package flare.vis.operator;
	 ...
	 */
	class OperatorSequence extends OperatorList
	{
		/** @private */
		public var _times:/*Number*/Array<Dynamic> ;
		...
		/** @inheritDoc */
		public override function remove(op:IOperator):Bool
		{
		...
		private function getFunction(op:IOperator):Dynamic {
