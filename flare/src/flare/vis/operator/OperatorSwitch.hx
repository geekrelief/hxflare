package flare.vis.operator;
	 ...
	 */
	class OperatorSwitch extends OperatorList
	{
		...
		public function getIndex():Int { return _cur; }
		public function setIndex(i:Int):Int { _cur = i; 	return i;}
		 ...
		 * run.
		 */
		public var indexFunction:Dynamic ;
