package flare.vis.operator.distortion;
	 ...
	 * </p>
	 */
	class BifocalDistortion extends Distortion
	{
	     ...
	     *  in the focal area
	     */
		public function new(?xRange:Float=0.1, ?xMagnify:Int=3,
			?yRange:Float=0.1, ?yMagnify:Int=3)
		{
			_rx = xRange;
	        _mx = xMagnify;
	        _ry = yRange;
		...
		{
			var xmag:Bool = false, ymag:Bool = false;
