package flare.vis.operator.encoder;
	 ...
	 */
	class SizeEncoder extends Encoder
	{
		public var palette(getPalette, setPalette) : Palette;
		public var sizes(getSizes, null) : SizePalette ;
		...
		public override function setPalette(p:Palette):Palette {
			_palette = cast( p, SizePalette);
			return p;
		}
		/** The palette as a SizePalette instance. */
		public function getSizes():SizePalette { return _palette; }
