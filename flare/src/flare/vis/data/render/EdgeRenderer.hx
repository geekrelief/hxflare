package flare.vis.data.render;
	 ...
	 */
	class EdgeRenderer implements IRenderer
	{		
		public var instance(getInstance, null) : EdgeRenderer ;		
		inline private static var ROOT3:Int = Math.sqrt(3);
		
		private static var _instance:EdgeRenderer = new EdgeRenderer();
		/** Static EdgeRenderer instance. */
		public static function getInstance():EdgeRenderer { return _instance; }
		...
		// temporary variables
		private var _p:Point , _q:Point ;
		private var _pts:Array<Dynamic> ;
		
		/** @inheritDoc */
		public function render(d:DataSprite):Void
		{
			var e:EdgeSprite = cast( d, EdgeSprite);
			if (e == null) { return; } // TODO: throw exception?
			var s:NodeSprite = e.source;
			var t:NodeSprite = e.target;
			var g:Graphics = e.graphics;
			
			var ctrls:Array<Dynamic> = cast( e.points, Array);
			var x1:Int = e.x1, y1:Int = e.y1;
			var x2:Int = e.x2, y2:Int = e.y2;
			var xL:Int = ctrls==null ? x1 : ctrls[ctrls.length-2];
			var yL:Int = ctrls==null ? y1 : ctrls[ctrls.length-1];
			...
			if (e.arrowType != ArrowType.NONE)
			{
				...
				var ah:Int = e.arrowHeight, aw:Int = e.arrowWidth/2;
				if (ah < 0 && aw < 0)
					aw = 1.5 * e.lineWidth;
				if (ah < 0) {
					ah = ROOT3 * aw;
		 ...
		 */
		public function setLineStyle(e:EdgeSprite, g:Graphics):Void
		{
			var lineAlpha:Int = e.lineAlpha;
